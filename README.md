# Commanded Event Shredder [![Build Status](https://travis-ci.org/KazW/commanded-event-shredder.svg?branch=master)](https://travis-ci.org/KazW/commanded-event-shredder)
